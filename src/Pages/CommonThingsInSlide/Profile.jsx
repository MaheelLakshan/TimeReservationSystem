...
function Profile() {
  ...
  const [department, setDepartment] = useState('Department of Electrical and Information Engineering');
        ...
        <div className="Profile">
          ...
          <form>
            ...
            <select id="department" value={department} onChange={handleDepartmentChange}>
              <option value="Electrical">Department of Electrical and Information Engineering</option>
              <option value="Civil">Department of Civil and Environmental Engineering</option>
              <option value="Mechanical">Department of Mechanical and Manufacturing Engineering</option>
              <option value="IS">Department of Interdisciplinary Studies</option>
              <option value="Marine">Department of Marine and Naval Architecture</option>
            </select>

            <label htmlFor="modules">Modules:</label>
            <textarea id="modules" value={modules} onChange={handleModulesChange} />

            <label htmlFor="contactNumber">Contact Number:</label>
            <input type="text" id="contactNumber" value={contactNumber} onChange={handleContactNumberChange} />

            <label htmlFor="emailAddress">Email Address:</label>
            <input type="email" id="emailAddress" value={emailAddress} onChange={handleEmailAddressChange} />
          </form>
