    ...
    <div className="AboutBackground">
      ...
      <div className="DeveloperPhotos">
        {developers.map((developer, index) => (
          <div className="DeveloperPhoto" key={index} onClick={() => handleDeveloperClick(index)}>
      ...
      >
        <img src={selectedDeveloper?.image} alt={selectedDeveloper?.name} className="DeveloperModalImage" />
