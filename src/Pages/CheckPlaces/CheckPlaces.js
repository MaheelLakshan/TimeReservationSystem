...
function CheckPlaces() {
  ...
  const renderInfoBox = () => {
    ...
    <div className="infoseminar">
      <p>Seminar Room which is equipped with audio and video 
        facilities and has a seating capacity of 125. Seminar Room is available for 
        other departments of the faculty.Reservation has to be made in advance with the 
        approval of the Head / Department of Interdisciplinary Studies.git checkout dev
